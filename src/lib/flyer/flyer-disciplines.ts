...
const DISCIPLINE_ALIAS_TO_LABEL: Record<string, FlyerExtractionDisciplineLabel> = {
  ...
  "barrel racing": "Barrel Racing (BR/CBR/CGBR)",
  br: "Barrel Racing (BR/CBR/CGBR)",
  cbr: "Barrel Racing (BR/CBR/CGBR)",
  cgbr: "Barrel Racing (BR/CBR/CGBR)",
  ...
  "breakaway roping": "Breakaway Roping (BA/CBA/BAW)",
  breakaway: "Breakaway Roping (BA/CBA/BAW)",
  ba: "Breakaway Roping (BA/CBA/BAW)",
  cba: "Breakaway Roping (BA/CBA/BAW)",
  baw: "Breakaway Roping (BA/CBA/BAW)",
...
const DISCIPLINE_INFERENCE_PATTERNS: Array<{
  ...
  { pattern: /\bbull riding\b/i, label: "Bull Riding" },
  ...
  { pattern: /\bbarrel racing\b/i, label: "Barrel Racing (BR/CBR/CGBR)" },
  { pattern: /\b(?:cbr|cgbr)\b/i, label: "Barrel Racing (BR/CBR/CGBR)" },
  { pattern: /\bbr\b/i, label: "Barrel Racing (BR/CBR/CGBR)" },
  ...
  { pattern: /\bbreakaway(?:\s+roping)?\b/i, label: "Breakaway Roping (BA/CBA/BAW)" },
  { pattern: /\b(?:cba|baw)\b/i, label: "Breakaway Roping (BA/CBA/BAW)" },
  { pattern: /\bba\b/i, label: "Breakaway Roping (BA/CBA/BAW)" },
