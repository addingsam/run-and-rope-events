...
- disciplines must use only allowed labels. Include every distinct jackpot structure or discipline clearly listed on the flyer, such as both Team Roping and Breakaway Roping when both appear. On full rodeo flyers, include all rough stock and timed events (for example Bareback, Saddle Bronc, Bull Riding, Barrel Racing, Team Roping), not only youth side events such as pole bending.
...
- format must be exactly "Jackpot" or "Rodeo" or null. When the flyer states it is a rodeo at any level (Open, Youth, Amateur, Ranch, Pro, or the word "rodeo" in the event title), set format to "Rodeo" regardless of which individual events or disciplines are listed. Rodeo format trumps jackpot-only disciplines when those appear as side events on a rodeo flyer.
- Cowboy Mounted Shooting, Ranch Horse, and Obstacle & Trail are jackpot events when the flyer is not a rodeo. When those appear on a rodeo flyer, keep format "Rodeo". Pole Bending / Poles may be either Jackpot or Rodeo — use Rodeo when the flyer is any level of rodeo, and Jackpot when the flyer is a standalone poles event with no rodeo level.
