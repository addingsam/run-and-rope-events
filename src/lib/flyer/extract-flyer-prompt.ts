...
- format must be exactly "Jackpot" or "Rodeo" or null. When the flyer states it is a rodeo at any level (Open, Youth, Amateur, Ranch, Pro, or the word "rodeo" in the event title), set format to "Rodeo" regardless of which individual events or disciplines are listed. Rodeo format trumps jackpot-only disciplines such as pole bending when those appear as side events on a rodeo flyer.
- Cowboy Mounted Shooting, Ranch Horse, and Obstacle & Trail are jackpot events when the flyer is not a rodeo. When those appear on a rodeo flyer, keep format "Rodeo". Pole bending / poles follow the same rule: jackpot when the flyer is not a rodeo, rodeo when the flyer is any level of rodeo.
